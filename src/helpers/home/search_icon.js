//! icon ları SVG olarak buraya taşıdık ve export edip diğer sayfalarda kullandık
...
export const search1 = (
  ...
  >
    <path
      d="M0 0H26C36.4934 0 45 8.50659 45 19V23C45 33.4934 36.4934 42 26 42H0V0Z"
      fill="#744BFC"
    />
  </svg>
);
...
export const left_go = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M8 13L2 7L8 0.999999" stroke="#744BFC" strokeWidth="2" />
  </svg>
);

export const right_go = (
  <svg
    width="9"
    height="14"
    viewBox="0 0 9 14"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M1 0.999999L7 7L0.999999 13" stroke="#744BFC" strokeWidth="2" />
  </svg>
);
